...
//     private readonly current: AxisRangeTuple
//     private readonly original: AxisRangeTuple
//     private readonly currentDistance: number
//     private readonly originalDistance: number
//
//     constructor(start: number, end: number) {
//         this.current = axisRangeTupleFrom(start, end)
//         this.original = axisRangeTupleFrom(start, end)
//         this.currentDistance = measureOf(this.current)
//         this.originalDistance = measureOf(this.original)
//     }
//
//     /**
...
//     translate: (amount: number, constraints?: [start: number, end: number] | undefined) => BaseAxisRange;
