export namespace SvgTableData {
     ...
     * @param columnInfo
     */
    export function withColumnHeader(columnInfo: Array<string> | Array<HeaderElementWithNameRequired>): TableRowHeader {
     ...
     */
    export function withoutHeaders(): TableHeaderData {
     ...
     * Create a table-data builder without a header (strange, but ok)
     */
    export function withoutColumnsHeader(): TableRowHeader {
    ...
    class TableHeaderData {
        ...
        public withDataAsRow(data: Array<Row>): TableHeaderDataFooter {
            ...
            const formattedData = data
                .map(row => row
                    .map((elem, columnIndex) => this.columnHeader[columnIndex].formatter(elem))
                )
